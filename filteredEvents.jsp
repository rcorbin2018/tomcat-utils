...
<body>
    <div class="container">
        <h1 class="my-4">Filtered Events - <c:out value="${filterType}" /> - Between <c:out value="${startDatetime}" /> and <c:out value="${endDatetime}" /> (EST)</h1>
        ...
        <c:if test="${empty events}">
            <div class="alert alert-info">No events found for <c:out value="${filterType}" /> between <c:out value="${startDatetime}" /> and <c:out value="${endDatetime}" /> (EST).</div>
        </c:if>
